...
func (s *Service) oauthToken(c echo.Context) error {
...
func (s *Service) tokensHandler(w http.ResponseWriter, r *http.Request) {
	...
	grantTypes := map[string]func(r *http.Request, client *entity.OauthClient) (*AccessTokenResponse, error){
...
func (s *Service) basicAuthClient(r *http.Request) (*entity.OauthClient, error) {
