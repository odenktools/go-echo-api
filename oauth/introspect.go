...
func (s *Service) introspectToken(r *http.Request, client *entity.OauthClient) (*IntrospectResponse, error) {
...
func (s *Service) NewIntrospectResponseFromAccessToken(accessToken *entity.OauthAccessToken) (*IntrospectResponse, error) {
...
func (s *Service) NewIntrospectResponseFromRefreshToken(refreshToken *entity.OauthRefreshToken) (*IntrospectResponse, error) {
	var introspectResponse = &IntrospectResponse{
		Active:    true,
